...
function theme_slug_widgets_init() {
	if ( function_exists( 'register_sidebar' ) ) // Widget Area Sidebar
	{
		register_sidebar(
			array(
				'id'            => 'sidebar-1',
 ...
 * *description* if a style.min.css file exists, use that, otherwise use style.css
 */
if ( ! function_exists( 'style_or_min_style' ) ) {
	function style_or_min_style() {
		...
		wp_enqueue_style( 'style_min', $path, array(), '0.2.0' );
	}
}
